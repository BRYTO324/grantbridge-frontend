...
import { User, Lock, Bell, Shield, Camera, Check, Save, Eye, EyeOff } from "lucide-react";
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="flex-1">
          <motion.div key={activeTab} initial={{ opacity: 0, x: 10 }} animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.2 }} className="bg-white rounded-2xl border border-slate-100 p-6 sm:p-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-6">
                  <div className="relative group">
                    <img src={avatarSrc} alt="Profile" className="w-24 h-24 rounded-2xl object-cover ring-4 ring-slate-100" />
                ...
                <div className="grid sm:grid-cols-2 gap-5">
                  <div>
                    ...
                    <Input type="text" value={formData.fullName}
                      onChange={(e) => setFormData({ ...formData, fullName: e.target.value })} placeholder="Your full name" />
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <Input type="tel" value={formData.phone}
                      onChange={(e) => setFormData({ ...formData, phone: e.target.value })} placeholder="+1 (555) 123-4567" />
                  </div>
                  <div>
                    <label className="block text-xs font-medium text-slate-600 mb-2">Company</label>
                    <Input type="text" value={formData.company}
                      onChange={(e) => setFormData({ ...formData, company: e.target.value })} placeholder="Your company name" />
                  </div>
                </div>
                    ...
                    <div key={key}>
                      ...
                      <div className="relative">
                        <Input type={show ? "text" : "password"}
                          ...
                          placeholder={`Enter ${label.toLowerCase()}`} error={errors[key]} />
